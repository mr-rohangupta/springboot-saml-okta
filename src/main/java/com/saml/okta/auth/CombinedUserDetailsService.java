...
import com.saml.okta.repository.UserRepository;
...
public class CombinedUserDetailsService implements UserDetailsService, SAMLUserDetailsService {
    ...
    public UserDetails loadUserByUsername(String s) throws UsernameNotFoundException {
        ...
        return new CustomUserDetails(AuthMethod.DATABASE,
    ...
    public Object loadUserBySAML(SAMLCredential samlCredential) throws UsernameNotFoundException {
        LOGGER.info("Loading UserDetails by SAMLCredentials: {}", samlCredential.getNameID());
        StoredUser storedUser = lookupUser(samlCredential.getNameID().getValue());
